...
package DownCounter_23 is
    ...
    function DownCounter(counter: sfixed(11 downto 0)) return self_t;
end package;
...
package body DownCounter_23 is
    ...
    begin
        ...
        if not pyha_ret_0 then
            self_next.counter := resize(self.counter - 1, 11, 0, fixed_wrap, fixed_truncate);
        end if;
    end procedure;

    function DownCounter(counter: sfixed(11 downto 0)) return self_t is
        -- constructor
