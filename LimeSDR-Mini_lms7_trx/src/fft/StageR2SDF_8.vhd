...
package StageR2SDF_8 is
    type self_t is record
        ...
        start_counter: DownCounter_13.self_t;
    end record;
    ...
    type self_t_const is record
        ...
        TWIDDLES: Typedefs.complex_t1downto_14_list_t(0 to 31);
        IS_TRIVIAL_MULTIPLIER: boolean;
        shr: ShiftRegister_15.self_t_const;
        \out\: DataValid_0.self_t_const;
        start_counter: DownCounter_13.self_t_const;
    end record;
    ...
    function StageR2SDF(shr: ShiftRegister_15.self_t; twiddle: complex_t(1 downto -14); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -48); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_0.self_t; start_counter: DownCounter_13.self_t) return self_t;
end package;
...
package body StageR2SDF_8 is
    ...
    begin
        ...
        DownCounter_13.tick(self.start_counter, self_next.start_counter, self_const.start_counter);
        DownCounter_13.is_over(self.start_counter, self_next.start_counter, self_const.start_counter, pyha_ret_4);
        self_next.\out\.valid := pyha_ret_4;
        ret_0 := self.\out\;
        return;
    end procedure;

    function StageR2SDF(shr: ShiftRegister_15.self_t; twiddle: complex_t(1 downto -14); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -48); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_0.self_t; start_counter: DownCounter_13.self_t) return self_t is
        -- constructor
