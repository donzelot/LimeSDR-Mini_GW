...
package ShiftRegister_0 is
    type self_t is record
        data: Typedefs.complex_t1downto_22_list_t(0 to 255);
    ...
    function ShiftRegister(data: Typedefs.complex_t1downto_22_list_t(0 to 255); to_push: complex_t(1 downto -22)) return self_t;
end package;
...
package body ShiftRegister_0 is
    ...
    function ShiftRegister(data: Typedefs.complex_t1downto_22_list_t(0 to 255); to_push: complex_t(1 downto -22)) return self_t is
        -- limited constructor
