...
package DownCounter_13 is
    type self_t is record
        counter: sfixed(6 downto 0);
    end record;
    type DownCounter_13_self_t_list_t is array (natural range <>) of DownCounter_13.self_t;

    type self_t_const is record
        START_VALUE: sfixed(6 downto 0);
    end record;
    type DownCounter_13_self_t_const_list_t_const is array (natural range <>) of DownCounter_13.self_t_const;
    ...
    function DownCounter(counter: sfixed(6 downto 0)) return self_t;
end package;

package body DownCounter_13 is
    ...
    begin
        ...
        if not pyha_ret_0 then
            self_next.counter := resize(self.counter - 1, 6, 0, fixed_wrap, fixed_truncate);
        end if;
    end procedure;

    function DownCounter(counter: sfixed(6 downto 0)) return self_t is
        -- constructor
