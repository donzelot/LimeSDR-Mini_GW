...
package StageR2SDF_1 is
    ...
    function StageR2SDF(shr: ShiftRegister_1.self_t; \out\: complex_t(1 downto -34)) return self_t;
end package;
...
package body StageR2SDF_1 is
    ...
    function StageR2SDF(shr: ShiftRegister_1.self_t; \out\: complex_t(1 downto -34)) return self_t is
        -- limited constructor
