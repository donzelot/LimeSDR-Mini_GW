...
package StageR2SDF_48 is
    ...
    type self_t_const is record
        ...
        TWIDDLES: Typedefs.complex_t1downto_14_list_t(0 to 3);
    ...
    function StageR2SDF(shr: ShiftRegister_46.self_t; twiddle: complex_t(1 downto -14); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -48); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_3.self_t; start_counter: DownCounter_47.self_t) return self_t;
end package;
...
package body StageR2SDF_48 is
    ...
    function StageR2SDF(shr: ShiftRegister_46.self_t; twiddle: complex_t(1 downto -14); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -48); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_3.self_t; start_counter: DownCounter_47.self_t) return self_t is
        -- constructor
