...
package DownCounter_38 is
    type self_t is record
        counter: sfixed(6 downto 0);
    end record;
    type DownCounter_38_self_t_list_t is array (natural range <>) of DownCounter_38.self_t;

    type self_t_const is record
        START_VALUE: sfixed(6 downto 0);
    end record;
    type DownCounter_38_self_t_const_list_t_const is array (natural range <>) of DownCounter_38.self_t_const;
...
package body DownCounter_38 is
