...
package DataValid_2 is
    ...
    function DataValid(data: sfixed(-9 downto -44); valid: boolean) return self_t;
end package;

package body DataValid_2 is


    function DataValid(data: sfixed(-9 downto -44); valid: boolean) return self_t is
        -- constructor
