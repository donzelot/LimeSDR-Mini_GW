...
package MovingAverage_7 is
    type self_t is record
        shr: ShiftRegister_5.self_t;
        acc: complex_t(21 downto -34);
        output: DataValid_3.self_t;
        start_counter: DownCounter_6.self_t;
    end record;
    type MovingAverage_7_self_t_list_t is array (natural range <>) of MovingAverage_7.self_t;
    ...
    type self_t_const is record
        ...
        start_counter: DownCounter_6.self_t_const;
    end record;
    type MovingAverage_7_self_t_const_list_t_const is array (natural range <>) of MovingAverage_7.self_t_const;
    ...
    function MovingAverage(shr: ShiftRegister_5.self_t; acc: complex_t(21 downto -34); output: DataValid_3.self_t; start_counter: DownCounter_6.self_t) return self_t;
end package;

package body MovingAverage_7 is
    ...
    begin
        ...
        ShiftRegister_5.push_next(self.shr, self_next.shr, self_const.shr, input.data);
        ...
        DownCounter_6.tick(self.start_counter, self_next.start_counter, self_const.start_counter);
        DownCounter_6.is_over(self.start_counter, self_next.start_counter, self_const.start_counter, pyha_ret_1);
        self_next.output.valid := pyha_ret_1;
        ret_0 := self.output;
        return;
    end procedure;

    function MovingAverage(shr: ShiftRegister_5.self_t; acc: complex_t(21 downto -34); output: DataValid_3.self_t; start_counter: DownCounter_6.self_t) return self_t is
        -- constructor
