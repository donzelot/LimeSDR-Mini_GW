...
package StageR2SDF_7 is
    ...
    function StageR2SDF(shr: ShiftRegister_7.self_t; control_delay: Typedefs.integer_list_t(0 to 2); twiddle: complex_t(1 downto -16); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -50); stage3_out: complex_t(1 downto -34)) return self_t;
end package;
...
package body StageR2SDF_7 is
    ...
    function StageR2SDF(shr: ShiftRegister_7.self_t; control_delay: Typedefs.integer_list_t(0 to 2); twiddle: complex_t(1 downto -16); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -50); stage3_out: complex_t(1 downto -34)) return self_t is
        -- limited constructor
