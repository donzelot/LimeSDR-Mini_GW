...
package StageR2SDF_6 is
    ...
    function StageR2SDF(shr: ShiftRegister_6.self_t; control_delay: Typedefs.integer_list_t(0 to 2); twiddle: complex_t(1 downto -16); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -50); stage3_out: complex_t(1 downto -34)) return self_t;
end package;
...
package body StageR2SDF_6 is
    ...
    begin
        ...
        if not (control and self_const.FFT_HALF) then
            ShiftRegister_6.push_next(self.shr, self_next.shr, self_const.shr, x);
    ...
    function StageR2SDF(shr: ShiftRegister_6.self_t; control_delay: Typedefs.integer_list_t(0 to 2); twiddle: complex_t(1 downto -16); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -50); stage3_out: complex_t(1 downto -34)) return self_t is
        -- limited constructor
