...
package StageR2SDF_6 is
    ...
    function StageR2SDF(shr: ShiftRegister_9.self_t; twiddle: complex_t(1 downto -16); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -50); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_0.self_t; start_counter: DownCounter_8.self_t) return self_t;
end package;
...
package body StageR2SDF_6 is
    ...
    function StageR2SDF(shr: ShiftRegister_9.self_t; twiddle: complex_t(1 downto -16); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -50); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_0.self_t; start_counter: DownCounter_8.self_t) return self_t is
        -- constructor
