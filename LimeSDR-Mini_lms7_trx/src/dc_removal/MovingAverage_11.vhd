...
package MovingAverage_11 is
    type self_t is record
        shr: ShiftRegister_16.self_t;
        acc: complex_t(23 downto -34);
        \out\: DataValid_0.self_t;
        start_counter: DownCounter_0.self_t;
    end record;
    type MovingAverage_11_self_t_list_t is array (natural range <>) of MovingAverage_11.self_t;
    ...
    type MovingAverage_11_self_t_const_list_t_const is array (natural range <>) of MovingAverage_11.self_t_const;
    ...
    function MovingAverage(shr: ShiftRegister_16.self_t; acc: complex_t(23 downto -34); \out\: DataValid_0.self_t; start_counter: DownCounter_0.self_t) return self_t;
end package;

package body MovingAverage_11 is
    ...
    begin
        ...
        self_next.acc := resize(self.acc + inp.data - pyha_ret_0, 11, -17, fixed_wrap, fixed_truncate);
    ...
    function MovingAverage(shr: ShiftRegister_16.self_t; acc: complex_t(23 downto -34); \out\: DataValid_0.self_t; start_counter: DownCounter_0.self_t) return self_t is
        -- constructor
