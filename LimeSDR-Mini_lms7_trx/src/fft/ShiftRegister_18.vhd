...
package ShiftRegister_18 is
    type self_t is record
        data: Typedefs.complex_t1downto_34_list_t(0 to 3);
        to_push: complex_t(1 downto -34);
    end record;
    type ShiftRegister_18_self_t_list_t is array (natural range <>) of ShiftRegister_18.self_t;

    type self_t_const is record
        DUMMY: integer;
    end record;
    type ShiftRegister_18_self_t_const_list_t_const is array (natural range <>) of ShiftRegister_18.self_t_const;
...
package body ShiftRegister_18 is
