...
package StageR2SDF_42 is
    ...
    type self_t_const is record
        ...
        TWIDDLES: Typedefs.complex_t1downto_16_list_t(0 to 15);
    ...
    function StageR2SDF(shr: ShiftRegister_40.self_t; twiddle: complex_t(1 downto -16); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -50); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_3.self_t; start_counter: DownCounter_41.self_t) return self_t;
end package;
...
package body StageR2SDF_42 is
    ...
    function StageR2SDF(shr: ShiftRegister_40.self_t; twiddle: complex_t(1 downto -16); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -50); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_3.self_t; start_counter: DownCounter_41.self_t) return self_t is
        -- constructor
