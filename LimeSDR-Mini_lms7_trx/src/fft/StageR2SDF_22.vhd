...
package StageR2SDF_22 is
    type self_t is record
        shr: ShiftRegister_20.self_t;
        ...
        start_counter: DownCounter_21.self_t;
    end record;
    type StageR2SDF_22_self_t_list_t is array (natural range <>) of StageR2SDF_22.self_t;
    ...
    type self_t_const is record
        ...
        TWIDDLES: Typedefs.complex_t1downto_16_list_t(0 to 2047);
        IS_TRIVIAL_MULTIPLIER: boolean;
        shr: ShiftRegister_20.self_t_const;
        \out\: DataValid_3.self_t_const;
        start_counter: DownCounter_21.self_t_const;
    end record;
    type StageR2SDF_22_self_t_const_list_t_const is array (natural range <>) of StageR2SDF_22.self_t_const;
    ...
    function StageR2SDF(shr: ShiftRegister_20.self_t; twiddle: complex_t(1 downto -16); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -50); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_3.self_t; start_counter: DownCounter_21.self_t) return self_t;
end package;

package body StageR2SDF_22 is
    ...
    begin
        ...
        if mode then
            ShiftRegister_20.push_next(self.shr, self_next.shr, self_const.shr, inp.data);
            ShiftRegister_20.peek(self.shr, self_next.shr, self_const.shr, pyha_ret_0);
            self_next.stage1_out := resize(pyha_ret_0, 0, -17, fixed_wrap, fixed_truncate);
        else
            ShiftRegister_20.peek(self.shr, self_next.shr, self_const.shr, pyha_ret_1);
            ...
            ShiftRegister_20.push_next(self.shr, self_next.shr, self_const.shr, down);
        ...
        DownCounter_21.tick(self.start_counter, self_next.start_counter, self_const.start_counter);
        DownCounter_21.is_over(self.start_counter, self_next.start_counter, self_const.start_counter, pyha_ret_4);
        self_next.\out\.valid := pyha_ret_4;
        ret_0 := self.\out\;
        return;
    end procedure;

    function StageR2SDF(shr: ShiftRegister_20.self_t; twiddle: complex_t(1 downto -16); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -50); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_3.self_t; start_counter: DownCounter_21.self_t) return self_t is
        -- constructor
