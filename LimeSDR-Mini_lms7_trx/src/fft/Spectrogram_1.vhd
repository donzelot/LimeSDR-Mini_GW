...
package Spectrogram_1 is
    ...
    function Spectrogram(dc_removal: DCRemoval_0.self_t; pack: Packager_0.self_t; windower: Windower_1.self_t; fft: R2SDF_1.self_t; \abs\: ConjMult_0.self_t; dec: BitreversalFFTshiftDecimate_0.self_t) return self_t;
end package;
...
package body Spectrogram_1 is
    procedure main(self:in self_t; self_next:inout self_t; constant self_const: self_t_const; x: complex_t(1 downto -34); ret_0:out DataWithIndex_3.self_t) is
        ...
        variable dc_out: complex_t(1 downto -34);
        ...
        variable pyha_ret_3: DataWithIndex_0.self_t;
        variable pyha_ret_4: DataWithIndex_3.self_t;
        variable pyha_ret_5: DataWithIndex_3.self_t;
    begin
        DCRemoval_0.main(self.dc_removal, self_next.dc_removal, self_const.dc_removal, x, pyha_ret_0);
        dc_out := resize(pyha_ret_0, 0, -17, fixed_wrap, fixed_truncate);
        Packager_0.main(self.pack, self_next.pack, self_const.pack, dc_out, pyha_ret_1);
        pack_out := pyha_ret_1;
        Windower_1.main(self.windower, self_next.windower, self_const.windower, pack_out, pyha_ret_2);
        window_out := pyha_ret_2;
        R2SDF_1.main(self.fft, self_next.fft, self_const.fft, window_out, pyha_ret_3);
        fft_out := pyha_ret_3;
        ConjMult_0.main(self.\abs\, self_next.\abs\, self_const.\abs\, fft_out, pyha_ret_4);
        mag_out := pyha_ret_4;
        BitreversalFFTshiftDecimate_0.main(self.dec, self_next.dec, self_const.dec, mag_out, pyha_ret_5);
        dec_out := pyha_ret_5;
        ret_0 := dec_out;
        return;
    end procedure;

    function Spectrogram(dc_removal: DCRemoval_0.self_t; pack: Packager_0.self_t; windower: Windower_1.self_t; fft: R2SDF_1.self_t; \abs\: ConjMult_0.self_t; dec: BitreversalFFTshiftDecimate_0.self_t) return self_t is
        -- limited constructor
