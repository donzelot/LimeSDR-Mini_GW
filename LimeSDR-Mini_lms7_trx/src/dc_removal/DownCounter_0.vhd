...
package DownCounter_0 is
    ...
    type DownCounter_0_self_t_list_t is array (natural range <>) of DownCounter_0.self_t;

    type self_t_const is record
        START_VALUE: sfixed(1 downto 0);
    end record;
    type DownCounter_0_self_t_const_list_t_const is array (natural range <>) of DownCounter_0.self_t_const;
...
package body DownCounter_0 is
    ...
    begin
        ...
        if not pyha_ret_0 then
            self_next.counter := resize(self.counter - 1, 1, 0, fixed_wrap, fixed_truncate);
        end if;
    end procedure;
