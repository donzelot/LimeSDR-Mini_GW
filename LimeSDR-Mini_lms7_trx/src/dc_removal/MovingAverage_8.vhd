...
package MovingAverage_8 is
    ...
    type MovingAverage_8_self_t_const_list_t_const is array (natural range <>) of MovingAverage_8.self_t_const;
    ...
    function MovingAverage(shr: ShiftRegister_12.self_t; acc: complex_t(21 downto -34); \out\: DataValid_0.self_t; start_counter: DownCounter_0.self_t) return self_t;
end package;

package body MovingAverage_8 is
    ...
    function MovingAverage(shr: ShiftRegister_12.self_t; acc: complex_t(21 downto -34); \out\: DataValid_0.self_t; start_counter: DownCounter_0.self_t) return self_t is
        -- constructor
