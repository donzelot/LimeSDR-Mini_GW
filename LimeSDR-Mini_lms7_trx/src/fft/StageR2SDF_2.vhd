...
package StageR2SDF_2 is
    type self_t is record
        ...
        start_counter: DownCounter_4.self_t;
    end record;
    ...
    type self_t_const is record
        ...
        shr: ShiftRegister_1.self_t_const;
        \out\: DataValid_0.self_t_const;
        start_counter: DownCounter_4.self_t_const;
    end record;
    ...
    function StageR2SDF(shr: ShiftRegister_1.self_t; twiddle: complex_t(1 downto -14); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -48); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_0.self_t; start_counter: DownCounter_4.self_t) return self_t;
end package;
...
package body StageR2SDF_2 is
    ...
    begin
        ...
        if mode then
            ShiftRegister_1.push_next(self.shr, self_next.shr, self_const.shr, inp.data);
            ShiftRegister_1.peek(self.shr, self_next.shr, self_const.shr, pyha_ret_0);
            self_next.stage1_out := resize(pyha_ret_0, 0, -17, fixed_wrap, fixed_truncate);
        else
            ShiftRegister_1.peek(self.shr, self_next.shr, self_const.shr, pyha_ret_1);
            ...
            ShiftRegister_1.push_next(self.shr, self_next.shr, self_const.shr, down);
        ...
        DownCounter_4.tick(self.start_counter, self_next.start_counter, self_const.start_counter);
        DownCounter_4.is_over(self.start_counter, self_next.start_counter, self_const.start_counter, pyha_ret_4);
        self_next.\out\.valid := pyha_ret_4;
        ret_0 := self.\out\;
        return;
    end procedure;

    function StageR2SDF(shr: ShiftRegister_1.self_t; twiddle: complex_t(1 downto -14); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -48); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_0.self_t; start_counter: DownCounter_4.self_t) return self_t is
        -- constructor
