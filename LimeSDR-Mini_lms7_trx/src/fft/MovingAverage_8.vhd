...
package MovingAverage_8 is
    ...
    function MovingAverage(shr: ShiftRegister_6.self_t; acc: complex_t(21 downto -34); output: DataValid_3.self_t; start_counter: DownCounter_7.self_t) return self_t;
end package;
...
package body MovingAverage_8 is
    ...
    begin
        ...
        ShiftRegister_6.push_next(self.shr, self_next.shr, self_const.shr, input.data);
    ...
    function MovingAverage(shr: ShiftRegister_6.self_t; acc: complex_t(21 downto -34); output: DataValid_3.self_t; start_counter: DownCounter_7.self_t) return self_t is
        -- constructor
