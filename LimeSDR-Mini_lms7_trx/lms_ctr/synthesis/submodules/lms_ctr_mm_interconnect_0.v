...
module lms_ctr_mm_interconnect_0 (
		...
		input  wire [20:0] nios2_cpu_instruction_master_address,        //          nios2_cpu_instruction_master.address
	...
	wire   [12:0] cmd_mux_006_src_channel;                                                         // cmd_mux_006:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [102:0] cmd_mux_007_src_data;                                                            // cmd_mux_007:src_data -> leds_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_008_src_data;                                                            // cmd_mux_008:src_data -> lms_ctr_gpio_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_009_src_data;                                                            // cmd_mux_009:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire          cmd_mux_010_src_valid;                                                           // cmd_mux_010:src_valid -> fpga_spi_spi_control_port_agent:cp_valid
	wire  [102:0] cmd_mux_010_src_data;                                                            // cmd_mux_010:src_data -> fpga_spi_spi_control_port_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                           // fpga_spi_spi_control_port_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [12:0] cmd_mux_010_src_channel;                                                         // cmd_mux_010:src_channel -> fpga_spi_spi_control_port_agent:cp_channel
	wire          cmd_mux_010_src_startofpacket;                                                   // cmd_mux_010:src_startofpacket -> fpga_spi_spi_control_port_agent:cp_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                                     // cmd_mux_010:src_endofpacket -> fpga_spi_spi_control_port_agent:cp_endofpacket
	...
	wire          cmd_mux_011_src_valid;                                                           // cmd_mux_011:src_valid -> dac_spi_spi_control_port_agent:cp_valid
	wire  [102:0] cmd_mux_011_src_data;                                                            // cmd_mux_011:src_data -> dac_spi_spi_control_port_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                           // dac_spi_spi_control_port_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [12:0] cmd_mux_011_src_channel;                                                         // cmd_mux_011:src_channel -> dac_spi_spi_control_port_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                                   // cmd_mux_011:src_startofpacket -> dac_spi_spi_control_port_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                     // cmd_mux_011:src_endofpacket -> dac_spi_spi_control_port_agent:cp_endofpacket
	...
	wire  [102:0] leds_s1_agent_rp_data;                                                           // leds_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [102:0] lms_ctr_gpio_s1_agent_rp_data;                                                   // lms_ctr_gpio_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [102:0] onchip_memory2_0_s1_agent_rp_data;                                               // onchip_memory2_0_s1_agent:rp_data -> router_011:sink_data
	...
	wire          fpga_spi_spi_control_port_agent_rp_valid;                                        // fpga_spi_spi_control_port_agent:rp_valid -> router_012:sink_valid
	wire  [102:0] fpga_spi_spi_control_port_agent_rp_data;                                         // fpga_spi_spi_control_port_agent:rp_data -> router_012:sink_data
	wire          fpga_spi_spi_control_port_agent_rp_ready;                                        // router_012:sink_ready -> fpga_spi_spi_control_port_agent:rp_ready
	wire          fpga_spi_spi_control_port_agent_rp_startofpacket;                                // fpga_spi_spi_control_port_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          fpga_spi_spi_control_port_agent_rp_endofpacket;                                  // fpga_spi_spi_control_port_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire          dac_spi_spi_control_port_agent_rp_valid;                                         // dac_spi_spi_control_port_agent:rp_valid -> router_013:sink_valid
	wire  [102:0] dac_spi_spi_control_port_agent_rp_data;                                          // dac_spi_spi_control_port_agent:rp_data -> router_013:sink_data
	wire          dac_spi_spi_control_port_agent_rp_ready;                                         // router_013:sink_ready -> dac_spi_spi_control_port_agent:rp_ready
	wire          dac_spi_spi_control_port_agent_rp_startofpacket;                                 // dac_spi_spi_control_port_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          dac_spi_spi_control_port_agent_rp_endofpacket;                                   // dac_spi_spi_control_port_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire          fpga_spi_spi_control_port_agent_rdata_fifo_src_valid;                            // fpga_spi_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] fpga_spi_spi_control_port_agent_rdata_fifo_src_data;                             // fpga_spi_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire          fpga_spi_spi_control_port_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_010:in_0_ready -> fpga_spi_spi_control_port_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_010_out_0_valid;                                               // avalon_st_adapter_010:out_0_valid -> fpga_spi_spi_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_010_out_0_data;                                                // avalon_st_adapter_010:out_0_data -> fpga_spi_spi_control_port_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                               // fpga_spi_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                               // avalon_st_adapter_010:out_0_error -> fpga_spi_spi_control_port_agent:rdata_fifo_sink_error
	wire          dac_spi_spi_control_port_agent_rdata_fifo_src_valid;                             // dac_spi_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] dac_spi_spi_control_port_agent_rdata_fifo_src_data;                              // dac_spi_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          dac_spi_spi_control_port_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_011:in_0_ready -> dac_spi_spi_control_port_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                               // avalon_st_adapter_011:out_0_valid -> dac_spi_spi_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                                // avalon_st_adapter_011:out_0_data -> dac_spi_spi_control_port_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                               // dac_spi_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                               // avalon_st_adapter_011:out_0_error -> dac_spi_spi_control_port_agent:rdata_fifo_sink_error
	...
	lms_ctr_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lms_ctr_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lms_ctr_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lms_ctr_mm_interconnect_0_rsp_demux_005 rsp_demux_005 (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lms_ctr_mm_interconnect_0_cmd_demux_001 rsp_demux_008 (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lms_ctr_mm_interconnect_0_cmd_demux_001 rsp_demux_009 (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lms_ctr_mm_interconnect_0_cmd_demux_001 rsp_demux_010 (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lms_ctr_mm_interconnect_0_cmd_demux_001 rsp_demux_011 (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lms_ctr_mm_interconnect_0_cmd_demux_001 rsp_demux_012 (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
