...
package body StageR2SDF_4 is
    ...
    begin
        ...
        if mode then
            ShiftRegister_7.push_next(self.shr, self_next.shr, self_const.shr, inp.data);
        ...
        DownCounter_6.is_over(self.start_counter, self_next.start_counter, self_const.start_counter, pyha_ret_4);
