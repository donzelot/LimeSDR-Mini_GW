...
package DataValid_1 is
    ...
    function DataValid(data: sfixed(-7 downto -38); valid: boolean) return self_t;
end package;

package body DataValid_1 is


    function DataValid(data: sfixed(-7 downto -38); valid: boolean) return self_t is
        -- constructor
