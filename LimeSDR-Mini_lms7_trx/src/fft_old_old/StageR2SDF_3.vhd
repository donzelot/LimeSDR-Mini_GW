...
package StageR2SDF_3 is
    ...
    function StageR2SDF(shr: ShiftRegister_3.self_t; \out\: complex_t(1 downto -34)) return self_t;
end package;
...
package body StageR2SDF_3 is
    ...
    function StageR2SDF(shr: ShiftRegister_3.self_t; \out\: complex_t(1 downto -34)) return self_t is
        -- limited constructor
