...
package StageR2SDF_24 is
    ...
    type self_t_const is record
        ...
        TWIDDLES: Typedefs.complex_t1downto_14_list_t(0 to 1023);
    ...
    function StageR2SDF(shr: ShiftRegister_9.self_t; twiddle: complex_t(1 downto -14); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -48); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_3.self_t; start_counter: DownCounter_23.self_t) return self_t;
end package;
...
package body StageR2SDF_24 is
    ...
    begin
        ...
        if mode then
            ShiftRegister_9.push_next(self.shr, self_next.shr, self_const.shr, inp.data);
            ...
            ShiftRegister_9.peek(self.shr, self_next.shr, self_const.shr, pyha_ret_1);
            ...
            ShiftRegister_9.push_next(self.shr, self_next.shr, self_const.shr, down);
    ...
    function StageR2SDF(shr: ShiftRegister_9.self_t; twiddle: complex_t(1 downto -14); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -48); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_3.self_t; start_counter: DownCounter_23.self_t) return self_t is
        -- constructor
