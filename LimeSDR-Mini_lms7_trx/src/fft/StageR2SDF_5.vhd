...
package StageR2SDF_5 is
    ...
    type StageR2SDF_5_self_t_list_t is array (natural range <>) of StageR2SDF_5.self_t;
    ...
    type StageR2SDF_5_self_t_const_list_t_const is array (natural range <>) of StageR2SDF_5.self_t_const;
    ...
    function StageR2SDF(shr: ShiftRegister_12.self_t; twiddle: complex_t(1 downto -14); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -48); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_0.self_t; start_counter: DownCounter_10.self_t) return self_t;
end package;

package body StageR2SDF_5 is
    ...
    function StageR2SDF(shr: ShiftRegister_12.self_t; twiddle: complex_t(1 downto -14); stage1_out: complex_t(1 downto -34); stage2_out: complex_t(1 downto -48); output_index: integer; mode_delay: boolean; control: integer; \out\: DataValid_0.self_t; start_counter: DownCounter_10.self_t) return self_t is
        -- constructor
