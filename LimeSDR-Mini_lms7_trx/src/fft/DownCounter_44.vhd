...
package DownCounter_44 is
    type self_t is record
        counter: sfixed(4 downto 0);
    end record;
    type DownCounter_44_self_t_list_t is array (natural range <>) of DownCounter_44.self_t;

    type self_t_const is record
        START_VALUE: sfixed(4 downto 0);
    end record;
    type DownCounter_44_self_t_const_list_t_const is array (natural range <>) of DownCounter_44.self_t_const;
...
package body DownCounter_44 is
