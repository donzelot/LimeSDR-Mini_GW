...
package ShiftRegister_16 is
    type self_t is record
        data: Typedefs.complex_t1downto_22_list_t(0 to 511);
    ...
    function ShiftRegister(data: Typedefs.complex_t1downto_22_list_t(0 to 511); to_push: complex_t(1 downto -22)) return self_t;
end package;
...
package body ShiftRegister_16 is
    ...
    function ShiftRegister(data: Typedefs.complex_t1downto_22_list_t(0 to 511); to_push: complex_t(1 downto -22)) return self_t is
        -- constructor
