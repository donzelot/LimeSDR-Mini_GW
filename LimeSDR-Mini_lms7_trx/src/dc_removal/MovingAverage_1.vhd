...
package MovingAverage_1 is
    ...
    type MovingAverage_1_self_t_list_t is array (natural range <>) of MovingAverage_1.self_t;
    ...
    type MovingAverage_1_self_t_const_list_t_const is array (natural range <>) of MovingAverage_1.self_t_const;
    ...
    function MovingAverage(shr: ShiftRegister_1.self_t; acc: complex_t(17 downto -34); \out\: DataValid_0.self_t; start_counter: DownCounter_0.self_t) return self_t;
end package;

package body MovingAverage_1 is
    ...
    function MovingAverage(shr: ShiftRegister_1.self_t; acc: complex_t(17 downto -34); \out\: DataValid_0.self_t; start_counter: DownCounter_0.self_t) return self_t is
        -- limited constructor
